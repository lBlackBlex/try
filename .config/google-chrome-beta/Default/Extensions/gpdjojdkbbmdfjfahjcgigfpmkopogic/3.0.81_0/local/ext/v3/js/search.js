// don't try to search with invalid parameters (scaledX or scaledY < 0; scaledH or scaledW > 1)
  ...
  let $ = {
    ...
    f: {
      ...
      detect: {
        ...
        reduce: o => {
          let r, c, i, k, canvas, ctx, imageData, tempArray, pix, hex, bgCounter, colorInventoryObject, colorInventoryArray, mod, bgHsv;
        ...
        select: o => {
          let r, c, flood, getNextFloodable, getArea, whatResult, minRow, minCol, maxRow, maxCol, toGo = 0, floodMe = {}, areaFound = [], mod;
          mod = {
            r: [-1, 0, 1, 0],
            c: [0, 1, 0, -1]
          };
      ...
      act: {
        ...
        showResults: r => {
          let i, p, thumb, mask, ft, ftDomain, desc, description, ftDeets, avatar, pinner, cc, tation, note, board, saveButton, searchButton, logMe, noteColor, anno, grid;
